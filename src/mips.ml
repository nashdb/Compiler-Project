 ...
 *)
  ...
  let format inst =
    ...
    *)
    ...
    | Negu  {rd; rs}          -> fmt2 "move\t%s, %s" rd rs
    | Seb   {rd; rs}          -> fmt2 "move\t%s, %s" rd rs
    | Seh   {rd; rs}          -> fmt2 "move\t%s, %s" rd rs
    | Sub   {rd; rs; rt}      -> fmt3 "move\t%s, %s, %s" rd rs rt
    | Subu  {rd; rs; rt}      -> fmt3 "move\t%s, %s, %s" rd rs rt
